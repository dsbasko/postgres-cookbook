...
Ключевые биты волны (детали — в записях карты сцен): камео-склейка Анны со
staff-Анной (04-02, ратифицирована §10.2), «неделя инцидентов» конкурентности
...
Особое: камео-склейка Анны со staff-Анной — легализуется прозой при первом
соседстве с данными `staff` («Анна из таблицы staff — это она и есть»),
ратификация §10.2; имена в демо/stdout не меняются.

- [ ] прочитать канон целиком, запись `04-02` в карте сцен, оба README юнита
- [ ] RU: микро-реплика по записи карты; гейты — чек-лист скилла lecture-writer
...
- [ ] прочитать канон целиком, запись `04-03` в карте сцен, оба README юнита
...
- [ ] прочитать канон целиком, запись `04-04` в карте сцен, оба README юнита
...
- [ ] прочитать канон целиком, запись `04-05` в карте сцен, оба README юнита
- [ ] RU: микро-диалог по записи карты
- [ ] EN: зеркало — число реплик именованных персонажей равно RU
- [ ] линтер юнита — зелёный; diff юнита — только два README
...
### Task 7: юнит `05-02-mvcc-mental-model` — шапка Зои над Заборчиком
...
Особое: вторая (последняя) «шапка Зои» курса — ритм по первому носителю 02-03
и §4.4 (чат-жанр строчными).

- [ ] прочитать канон целиком, запись `05-02` в карте сцен, оба README юнита
- [ ] RU: шапка Зои по записи карты
- [ ] EN: зеркало — число реплик именованных персонажей равно RU
- [ ] линтер юнита — зелёный; diff юнита — только два README
...
Особое: лучшая боль-проза модуля (write-skew) НЕ заменяется — рапорт Анны
...
Особое: тикет Дани «база нестабильна» — нормализация ошибки, Даня не
...
к 02-06); мостик-реплика Зои в модуль 06 — дословно по §6 канона; запись в
«блокнот Зои» (нить §7).
...
Особое: рапорт Анны гармонизировать с канонной болью юнита (админка, вечер) —
...
и рифма постмортемов); блокнот Зои открыт на странице 02-06.
...
- Приёмка волны: выборочное чтение (минимум все ★, шапка Зои 05-02, рифма
  06-06), RU и EN.
