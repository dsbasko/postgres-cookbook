...
- [x] прочитать канон целиком, запись `04-06` в карте сцен, оба README юнита
...
- [x] прочитать канон целиком, запись `05-01` в карте сцен, оба README юнита
- [x] RU: микро-диалог по записи карты
- [x] EN: зеркало — число реплик именованных персонажей равно RU
- [x] линтер юнита — зелёный; diff юнита — только два README
...
- [x] прочитать канон целиком, запись `05-02` в карте сцен, оба README юнита
- [x] RU: шапка Павла по записи карты
- [x] EN: зеркало — число реплик именованных персонажей равно RU
- [x] линтер юнита — зелёный; diff юнита — только два README
...
- [x] прочитать канон целиком, запись `05-03` в карте сцен, оба README юнита
- [x] RU: микро-реплика по записи карты
- [x] EN: зеркало — число реплик именованных персонажей равно RU
- [x] линтер юнита — зелёный; diff юнита — только два README
...
- [x] прочитать канон целиком, запись `05-04` в карте сцен, оба README юнита
- [x] RU: микро-реплика + перекур по записи карты
- [x] EN: зеркало — число реплик именованных персонажей равно RU
- [x] линтер юнита — зелёный; diff юнита — только два README
...
- [x] прочитать канон целиком, запись `05-05` в карте сцен, оба README юнита
- [x] RU: сцена по записи карты (cap ×1.5, сцена заменяет прозу реакции)
- [x] EN: зеркало — число реплик именованных персонажей равно RU
- [x] линтер юнита — зелёный; diff юнита — только два README
...
- [x] прочитать канон целиком, запись `05-06` в карте сцен, оба README юнита
...
- [x] прочитать канон целиком, запись `06-01` в карте сцен, оба README юнита
- [x] RU: микро-диалог по записи карты
- [x] EN: зеркало — число реплик именованных персонажей равно RU
- [x] линтер юнита — зелёный; diff юнита — только два README
...
- [x] прочитать канон целиком, запись `06-02` в карте сцен, оба README юнита
- [x] RU: микро-реплика + перекур по записи карты
- [x] EN: зеркало — число реплик именованных персонажей равно RU
- [x] линтер юнита — зелёный; diff юнита — только два README
...
- [x] прочитать канон целиком, запись `06-03` в карте сцен, оба README юнита
- [x] RU: микро-реплика по записи карты
- [x] EN: зеркало — число реплик именованных персонажей равно RU
- [x] линтер юнита — зелёный; diff юнита — только два README
...
- [x] прочитать канон целиком, запись `06-04` в карте сцен, оба README юнита
- [x] RU: микро-реплика + перекур по записи карты
- [x] EN: зеркало — число реплик именованных персонажей равно RU
- [x] линтер юнита — зелёный; diff юнита — только два README
...
- [x] прочитать канон целиком, запись `06-05` в карте сцен, оба README юнита
- [x] RU: микро-реплика по записи карты
- [x] EN: зеркало — число реплик именованных персонажей равно RU
- [x] линтер юнита — зелёный; diff юнита — только два README
...
- [x] прочитать канон целиком, запись `06-06` в карте сцен, оба README юнита
- [x] RU: сцена по записи карты (cap ×1.5)
- [x] EN: зеркало — число реплик именованных персонажей равно RU
- [x] линтер юнита — зелёный; diff юнита — только два README
...
- [x] полный линтер волны: `node
  ...
  предупреждения разобраны (0 нарушений, 21 предупреждение: эвристика
  «возможный род» в ремарках о мужских персонажах + word-count заметки —
  ложноположительные/справочные, разобраны)
- [x] нити §7: греп по греп-маркерам (RU и EN) для нитей волны; список
  «setup написан, payoff ещё нет» отметить в реестре §7 канона (все восемь
  нитей волны сверены грепом; блок «После волны II» записан в §7.1)
- [x] сверка голосов: все сцены волны подряд «глазами» каждого говорившего
  персонажа против реестра §2; отклонения поправить (Павел — строчные
  назывные + «зачем.»; Дмитрий — «как база ответила»/вердикты; Ботыр —
  «Четыре»; Евгений — «строка, а не число» — реестр выдержан)
- [x] `make web-check-coverage` и `make web-build` — зелёные (63/63 RU/EN,
  0 mismatches; build 153 html + sitemap/OG)
- [x] скоуп прогона: каждый коммит прогона (все они правят этот план-файл;
  ...
  (проверено — только i18n/{ru,en}/README.md)
- [x] все требования Overview выполнены (17 юнитов, ключевые биты волны на
  месте: развод Руслан/staff-Анна 04-02, «неделя инцидентов» 05, рифма
  постмортемов 02-06 → 06-06)
