...
- Главное правило байт-совместимости: генерируемые столбцы и домены — только на **новых** таблицах (`gen_lab` здесь, `shops`/`order_items` в каноне), а шесть CDC-таблиц Brew держим дословно — иначе сломается handoff 10-05.
