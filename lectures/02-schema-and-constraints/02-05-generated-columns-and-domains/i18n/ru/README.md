...
> **Ботыр:** `VIRTUAL` же бесплатный: запись даром, места ноль. Делаем всё `VIRTUAL`?
>
> **Дмитрий:** Бесплатный при записи. Кто платит при чтении?

Ответ — в строке «цена чтения»: формулу пересчитывает каждый `SELECT`, а индекс на такую колонку не повесить. «Всё `VIRTUAL`» перекладывает цену с редкой записи на каждое чтение.
