...
Восемь минут — от релиза до kill — обе кассы не пробили ни одного заказа: таблица в десятки миллионов строк переписывалась под блокировкой. Вечером — первый постмортем, в графе «автор» — ты. Зоя молча достаёт новый бумажный блокнот и записывает дату.
