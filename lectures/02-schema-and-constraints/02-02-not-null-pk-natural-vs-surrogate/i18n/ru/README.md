...
Стас спускается со своего этажа — телефон уже экраном к тебе: макет вывески, вместо `BREW-NORTH` — `BREW-NEVA`.

> **Стас:** Ребрендинг. Вторая точка ещё не открылась, а Виктор уже подписал: не NORTH, а NEVA. В базе это же один UPDATE? К понедельнику.
>
> **Ты:** Похоже на то. Одна строка в shops, UPDATE по коду…
>
> **Марат:** Что ссылается на этот код?

Ссылается многое. Таблице кофеен Brew первичным ключом достался человекочитаемый код: `BREW-CENTRAL`, `BREW-NORTH`. Логично — код короткий, говорящий, по нему удобно искать. Но на этот код по внешним ключам сослались остатки на складе и позиции заказов, и «переименовать» здесь — значит сменить **значение первичного ключа**: каскадом править код во всех ссылающихся таблицах, а отчёты, которые держат старый код в кэше, начнут ссылаться в пустоту. «Это же один UPDATE» — то самое «просто», о котором Даня предупреждал в первый день. Боль не в переименовании, а в том, что **изменчивый бизнес-код сделали идентичностью строки**.
