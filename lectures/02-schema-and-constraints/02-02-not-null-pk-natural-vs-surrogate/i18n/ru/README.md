...
- Натуральный ключ хорош для действительно неизменных значений (коды валют, стран) и в стыковочных таблицах «многие-ко-многим», где составной натуральный PK естественен (наш канон `inventory (shop_id, drink_id)` — ровно такой).
