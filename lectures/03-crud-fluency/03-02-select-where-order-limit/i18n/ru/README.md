...
Меню Brew в приложении показывают постранично: «ещё 20 напитков», «следующая страница». Пока страниц мало — всё работает. А сегодня Стас спускается с телефоном экраном вперёд — на нём жалоба гостя из приложения.

> **Стас:** Гость долистал меню до пятисотой страницы — и приложение задумалось. Почему низ меню медленнее верха, кофе-то тот же?
...
> **Даня:** Каюсь: я всю жизнь беру LIMIT/OFFSET, а глубокие страницы кэширую. На тесте летало.
>
> **Марат:** Посчитай, сколько строк база прочитала ради страницы пятьсот.
