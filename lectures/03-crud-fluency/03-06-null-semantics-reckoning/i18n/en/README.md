...
> **Ruslan (in chat, 09:20):** The app. Menu's empty. 09:20. Guests are ordering at the counter.
...
>
> **Dmitry:** The query is honest. Second question: what did the database say?
>
> **You:** Zero rows. Not a single error — that's the scary part.

The trail leads into `unavailable`: yesterday the stop-list was edited by hand, and in one row a `NULL` sits where a drink id should be. The edit itself was needed — Evgeny was pulling a seasonal raf off sale. Dmitry writes on a napkin: `true AND NULL = NULL`.

> **Evgeny:** The same NULL that eats my customers? Now it's gone after the menu?
>
> **Dmitry:** It doesn't eat anyone. For every drink the database answered "unknown" — and to WHERE, "unknown" means "no."
...
> **Botyr:** Hold on, NULL = NULL has to be true: "don't know" on the left, "don't know" on the right. They're identical.
>
> **Dmitry:** NULL isn't a value, it's "don't know." Does "don't know" equal "don't know"?
>
> **Botyr:** …I don't know.
>
> **Dmitry:** That's exactly how the database answers.
...
This is the end of module 03 — "CRUD fluency." In the evening Evgeny finishes reading the stop-list postmortem — and lingers at your desk.

> **Evgeny:** I've got NULL memorized. Now tell me: how many more are out there like Karina — signed up and gone quiet?
