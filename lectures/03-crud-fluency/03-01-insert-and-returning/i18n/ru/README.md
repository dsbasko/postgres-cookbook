...
Программа лояльности Brew дорастает от регистраций до карт. Стас спускается в опенспейс с телефоном экраном вперёд: на нём макет кассового экрана с пустым полем для номера карты.
