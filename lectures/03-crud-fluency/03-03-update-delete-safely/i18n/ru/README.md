...
У тебя на экране — `UPDATE` по заказам. Даня разворачивается на стуле, не дожидаясь Enter.

> **Даня:** Пятница, вечер, UPDATE по orders. Мой самый дорогой инцидент начинался ровно так.
>
> **Ты:** Тот самый? Одна строка?
>
> **Даня:** Одна. `UPDATE orders SET status = 'cancelled'` — а `WHERE` остался в голове. Ни одной ошибки — и все заказы Brew отменены. Все. Это было до твоего прихода: звонки из кофейни, откат из бэкапа до полуночи.
>
> **Марат:** Запрос был синтаксически безупречен — в этом и ужас. База сделала ровно то, что попросили.
>
> **Ты:** А как увидеть масштаб до того, как всё станет навсегда?
>
> **Марат:** Между командой и «навсегда» бывает окно. Сегодня разберём, как его открывать.
>
> **Даня:** С тех пор пальцы жмут BEGIN раньше, чем голова закончит мысль. Дорогая привычка — в смысле, дорого досталась.
