...
> **Ботыр:** Погоди. Значит фрейм по умолчанию при `ORDER BY` — это `RANGE`? Мой running total из 08-01 накапливался не потому, что я так задумал, а потому что фрейм сам так решил?
>
