...
Твоя задача как разработчика — **узнавать non-sargable условие в своём запросе** (столбец завёрнут в функцию/арифметику) и либо разворачивать его, либо ставить индекс по выражению.
