...
> **Даня (в чате):** Переставил колонки в `SELECT` — тесты зелёные, а латте на витрине уехал в категорию tea. `Scan` промолчал: `name` и `category` — обе `text`, компилятору всё равно.
