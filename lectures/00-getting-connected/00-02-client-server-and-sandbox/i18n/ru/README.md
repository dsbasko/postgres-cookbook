...
Карта курса из 00-01 — позади, теперь первый технический шаг. Ближе к обеду в командном чате всплывает сообщение от Зои — обещание из первого дня исполнено.

> **Зоя (в чате):** песочница готова. docker compose up -d — и postgres твой. ломай сколько хочешь.
>
> **Ты:** А боевая база?
>
> **Зоя (в чате):** всё, что внутри сервера, — моё. ты — клиент с той стороны сокета. прод не проси.
