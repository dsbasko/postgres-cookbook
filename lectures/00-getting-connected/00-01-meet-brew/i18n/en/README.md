...
First contact. We connect to the sandbox, ask the server for its version (to confirm it's Postgres 18 on the other end), and take a census of the Brew world — checking Dmitry's words: how many rows sit in each of the 9 canon tables after the seed. No SQL heroics, just "look around before getting to work."
