...
База знаний Brew разрослась: статьи о приготовлении, гайды, заметки бариста. С утра в чате — рапорт Руслана:

> **Руслан (в чате, 09:15):** Новички не находят гайды. Ищут «brewing» — статья про «brew» молчит. Поиск по подстроке, да?

Тикет прилетает в команду. Ботыр реагирует первым:

> **Ботыр:** Тащим Elasticsearch? Отдельный движок, поиск из коробки.
>
> **Дмитрий:** Сначала посмотрим, что умеет база.
...
> **Евгений (в чате):** Гости ищут «limited» — сезонное. Пусть заголовок с этим словом весит больше статьи, где оно случайно мелькнуло в описании.
