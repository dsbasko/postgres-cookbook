...
Евгений спускается с телефоном экраном вперёд — на экране заказ гостя: «овсяное, двойной сироп, без кофеина, корицу сверху».

> **Евгений:** Фильтр «всё с подарком» работает. Теперь хочу сами опции — прямо в заказах. Этот гость собрал вот такое, следующий соберёт другое. У каждого свой набор — мне нужно поле для всего.
>
> **Ты:** Добавим колонки? `milk`, `size`, `syrup`, `extras`…
>
> **Дмитрий:** Сколько их будет к весне? Сироп, второй сироп, температура, «без крышки», аллергены. Сорок nullable-колонок. Можно. Но больно.
>
> **Ты:** А если набор заранее не знаем?
>
> **Дмитрий:** Тогда его не раскладывают по колонкам. Бесформенное и разреженное — в один `jsonb`. Колонка `options`, и любой набор влезает.
>
> **Евгений:** А фильтровать по ним смогу? Найти заказы на овсяном?

Фильтровать — сможешь: у `jsonb` для этого есть свой оператор, и тот самый GIN из 06-05 его ускоряет. Первым делом научимся доставать и проверять.
