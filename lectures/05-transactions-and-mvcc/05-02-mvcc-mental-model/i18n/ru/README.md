...
> **Ботыр:** Погоди. `UPDATE` не перезаписывает, `DELETE` не удаляет… база что, только пухнет?
>
> **Дмитрий:** Пухнет. Мёртвые версии лежат, пока их не приберёт `VACUUM`.
>
> **Ботыр:** А если не приберёт?
>
> **Дмитрий:** Тогда придёт Павел. Держи транзакции короткими — и не придёт.
...
> **Павел — в ревью, одной строкой:** Твой забытый BEGIN держит мне VACUUM всей базы.
