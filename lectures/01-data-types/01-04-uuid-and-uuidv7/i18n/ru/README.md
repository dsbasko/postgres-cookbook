...
Пророчество Дмитрия из 00-01 сбывается: Евгений впервые спускается со своего этажа лично — телефон уже развёрнут экраном к тебе.

> **Евгений:** Маленькая доработка. Каждому участнику лояльности — личная ссылка на его регистрацию. Макет готов: `brew.app/signup/42`. К пятнице флаеры в печать.
>
> **Ты:** А 42 — это порядковый номер из базы? Его же видно в URL.
>
> **Евгений:** Число как число. Кому оно интересно, кроме нас?

Доработка и правда выходит маленькой: id уже есть, ссылка собирается за вечер. Ответ на вопрос Евгения приходит через неделю — конкурент публикует пост «у Brew всего 42 регистрации лояльности», и число точное: `/signup/42` перебирается, соседние номера честно отвечают, последовательный id светит и объём, и порядок. Первый фикс напрашивается сам — заменить ключ на случайный `uuid` (`gen_random_uuid()`, версия 4): такой не переберёшь. А ещё через неделю в командном чате появляется Павел.

> **Павел (в чате):** loyalty_signups. после переезда на v4 вставки просели. «последние регистрации» по ключу не сортируются. кто выбирал тип.
...
> **Павел — в ревью, одной строкой:** `customers.id` не трогаем. Контракт с соседней командой.
