...
У Brew появился первый партнёр — сервис доставки, который забирает заказы кофеен в свою аналитику; его серверы живут в UTC. Наутро после первой синхронизации Стас приносит в чат две выгрузки одного и того же дня.

> **Стас (в чате):** Заказ один и тот же. В нашей выгрузке — 12:00 по Москве, в партнёрской — 09:00. Какое из них настоящее?
>
> **Зоя (в чате):** настоящих ноль. колонка без зоны. база хранит то, что ей дали.
...
> **Даня:** В прошлом проекте мы «просто» хранили время в bigint — миллисекунды от эпохи. Никаких зон, никаких проблем.
>
> **Марат:** Во сколько открывается кофейня?
>
> **Даня:** В восемь. По местным.
>
> **Марат:** А «утро» акции «кофе до одиннадцати» — чьё утро? Момент миллисекунды держат, как timestamptz. Настенные часы бизнеса — нет. Зона не исчезла — она переехала тебе в голову.
