...
Редкая неделя: в Brew ничего не горит. Стас спускается в опенспейс без пожара — с планом и тремя запросами сразу.

> **Стас:** Смотри, что накопилось. Напиткам нужны размеры — S, M, L, это каждый второй заказ. Блогу — теги. И гости просят сироп, корицу, «без крышки» — куда это класть?
...
> **Стас (в чате):** Вторая точка согласована — Виктор подписал план. На следующей неделе принесу список задач: меню, клиенты, заказы — всё должно уметь работать на два адреса.
